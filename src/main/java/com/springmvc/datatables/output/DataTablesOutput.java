package com.springmvc.datatables.output;
...
public class DataTablesOutput implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8460320206083124290L;
